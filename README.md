# 3時間ループメーカー for Spotify

曲1枠、曲2枠、曲3枠から1曲ずつ選び、指定時間ぎりぎりまで繰り返すSpotifyプレイリストを作るWebアプリです。
...
- 曲1枠、曲2枠、曲3枠のSpotify track URL
- 曲の長さ、例 `3:45`
- プレイリスト名
- 目標時間、通常は `180`

各枠は複数曲にできます。たとえば曲1枠、曲2枠、曲3枠にそれぞれ2曲入れた場合は、曲1-1、曲2-1、曲3-1、曲1-2、曲2-2、曲3-2のように、各枠から1曲ずつ順番に選んで繰り返します。枠ごとの曲数が違う場合は、それぞれの枠の中で先頭に戻って続きます。

各枠の中の曲順は上下ボタンで変更できます。曲1枠、曲2枠、曲3枠そのものの順番も左右ボタンで変更できます。
